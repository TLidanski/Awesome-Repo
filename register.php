	...
	if($_POST['email'] != '' && $_POST['username'] != '' && $_POST['password'] != '' && $_POST['confirm'] != '' ) {
		if($_POST['password'] == $_POST['confirm']) {
			if(filter_var($_POST['email'], FILTER_VALIDATE_EMAIL)) {
				...
				header("Location: /BeStrong/index.php");
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <form id="login-form" action="http://phpoll.com/login/process" method="post" role="form" style="display: block;">
                                    <div class="form-group">
                                        <input type="text" name="username_" id="username_" tabindex="1" class="form-control" placeholder="Username" value="">
                                    </div>
                                    <div class="form-group">
                                        <input type="password" name="password_" id="password_" tabindex="2" class="form-control" placeholder="Password">
                                    </div>
